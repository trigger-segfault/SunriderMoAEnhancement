init +2:
    ...
    screen load:
        ...
        # Goodbye drag, it's causing a bug where variables inside GetField
        # are thrown into store meaning you wouldn't be able to remove this
        # mod anymore due to missing EnhancedModUI class attribute in store.
        #drag:
