            ...
            fixed at tr_fadein(0):
                ...
                if eui.option_show == 2:
                    ...
                    imagebutton:
                        ...
                        action SetField(emod,"english_battle_voices",False)
                        hover_sound "sound/hover1.ogg"
                        activate_sound "sound/button1.ogg"
                    ...
                    imagebutton:
                        ...
                        action SetField(emod,"english_battle_voices",True)
                        hover_sound "sound/hover1.ogg"
                        activate_sound "sound/button1.ogg"
        ...
        drag:
            ...
            fixed at tr_fadein(0):
                ...
                imagebutton:
                    ...
                    idle "UI/load_cancel.png"
                    hover tr_hoverglow("UI/load_cancel.png")            
                    action (Hide("gameprefs"))#,Hide("option_main"),Hide("option_audio"),Hide("option_gameplay"),SetVariable("show_preference",False))
                    hover_sound "sound/hover1.ogg"
                    activate_sound "sound/button1.ogg"
